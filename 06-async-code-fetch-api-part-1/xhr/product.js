const data = {
  ...
  "title": "Соска (пустышка) NUK 10729357 <span style='color: red'>Some text</span>",
  "description": "Соска (пустышка)",
  "quantity": 20,
  "subcategory": {
  ...
  "images": [
    {
      "url": "<img src=\"no-exist\" onerror=console.error('document.cookie', document.cookie);>",
      "source": "872403.jpg"
    },
    {
